...
import { invalidatePermissionCache } from '../utils/streamChatPermissions'
import './StreamChatSettings.css'

const StreamChatSettings = () => {
    const { currentUser } = useMemberAuth()
    const { getChatSettings, updateChatSettings, isConnected } = useStreamChat()
    ...
    if (loading) {
        return (
            <div className="stream-chat-settings">
    ...
    return (
        <div className="stream-chat-settings">
            ...
            <div className="stream-chat-settings-content">
...
export default StreamChatSettings
