 ...
 * @param {string} recipientId - Stream Chat user ID of the recipient
 * @param {Function} getChatSettings - Function to get chat settings from Stream Chat
 ...
 * @param {string} senderEmail - Email of the sender
 * @param {string[]} recipientIds - Array of Stream Chat user IDs
 * @param {Function} getChatSettings - Function to get chat settings from Stream Chat
